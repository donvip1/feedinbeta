-- Fix get_feed_with_rotation - posts table doesn't have boost_level
...
BEGIN
  ...
  -- Get promoted posts from post_promotions table
  promoted_posts AS (
    ...
    SELECT 
      ...
      (
        ...
        CASE 
          ...
          ELSE 0
        END +
        -- Check promotion boost from post_promotions table
        COALESCE((
          SELECT CASE 
