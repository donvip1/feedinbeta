...
BEGIN
  ...
  -- Determine receiver: use p_receiver_id if provided, otherwise get space host
  ...
  INSERT INTO credit_transactions (user_id, amount, type, description, related_id)
  VALUES (v_receiver_id, v_receiver_amount, 'live_gift_received', 'Space gift received: ' || p_gift_type, p_space_id);
