...
export default function ThesisWriter() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Generate thesis
      const systemPrompt = `You are an expert academic thesis writer. Create a comprehensive, well-structured thesis based on the user's topic. Include:
- Abstract
- Introduction
- Literature Review
- Methodology
- Main Body (with proper sections)
- Conclusion
- References (suggested)

Use formal academic language and proper citations format.`;
      ...
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
        <div className="container max-w-2xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-semibold">Thesis Writer</h1>
          </div>
        </div>
      </div>
      ...
      <div className="container max-w-2xl mx-auto px-4 py-6 space-y-6">
        <div className="bg-card rounded-lg p-4 border">
          <p className="text-sm text-muted-foreground mb-4">
            Enter your thesis topic and let AI generate a comprehensive academic thesis for you.
          </p>
          <Textarea
        ...
        {result && (
          <div className="bg-card rounded-lg p-4 border">
            <h3 className="font-semibold mb-3">Generated Thesis:</h3>
