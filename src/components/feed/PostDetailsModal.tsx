...
import { MapPin, Hash, AtSign, Globe, Users, UserCheck, Lock, Clock, Loader2 } from 'lucide-react';
...
export function PostDetailsModal({ open, onClose, mediaUrl, mediaType, effects, onSuccess }: PostDetailsModalProps) {
  const { user } = useAuth();
