      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-md max-h-[80vh] bg-background rounded-t-3xl sm:rounded-3xl border border-border overflow-hidden"
          >
            {/* Header */}
            ...
            <Tabs defaultValue="gifts" className="w-full">
              ...
              <TabsContent value="gifts" className="p-4 space-y-4">
                ...
                <div>
                  ...
                  <ScrollArea className="h-32 border rounded-xl p-2 bg-muted/30">
                  ...
                  {GIFTS.map((gift) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-[11px] font-medium">{gift.name}</span>
                        <div className="flex items-center gap-1 mt-0.5">
                          <Coins className="w-3 h-3 text-amber-400" />
                          <span className="text-[10px] text-amber-500 font-semibold">{gift.value}</span>
                        </div>
                      </motion.button>
                    );
                  })}
